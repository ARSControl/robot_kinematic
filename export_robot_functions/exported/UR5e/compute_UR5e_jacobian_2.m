function J = compute_UR5e_jacobian_2(q)
...
J(1,1) = 0.425*cos(q1)*sin(q0) - 0.3922*sin(q0)*sin(q1)*sin(q2) + 0.3922*cos(q1)*cos(q2)*sin(q0);
...
J(2,1) = 0.3922*cos(q0)*sin(q1)*sin(q2) - 0.3922*cos(q0)*cos(q1)*cos(q2) - 0.425*cos(q0)*cos(q1);
