...
extern "C" void compute_UR5e_direct_kinematic_2(double* result, double *q) {
...
T(0,3) = cos(q0)*cos(q1)*-4.25E-1-cos(q0)*cos(q1)*cos(q2)*3.922E-1+cos(q0)*sin(q1)*sin(q2)*3.922E-1;
...
T(1,3) = cos(q1)*sin(q0)*-4.25E-1+sin(q0)*sin(q1)*sin(q2)*3.922E-1-cos(q1)*cos(q2)*sin(q0)*3.922E-1;
...
T(2,3) = sin(q1)*-4.25E-1-cos(q1)*sin(q2)*3.922E-1-cos(q2)*sin(q1)*3.922E-1+1.625E-1;
