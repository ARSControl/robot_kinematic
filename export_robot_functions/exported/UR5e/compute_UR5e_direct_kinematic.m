...
T(1,4) = 0.13333*sin(q0) - 0.425*cos(q0)*cos(q1) + 0.0996*cos(q4)*sin(q0) - 0.0996*sin(q4)*(cos(q3)*(cos(q0)*cos(q1)*cos(q2) - 1.0*cos(q0)*sin(q1)*sin(q2)) - 1.0*sin(q3)*(1.0*cos(q0)*cos(q1)*sin(q2) + 1.0*cos(q0)*cos(q2)*sin(q1))) + 0.0997*sin(q3)*(cos(q0)*cos(q1)*cos(q2) - 1.0*cos(q0)*sin(q1)*sin(q2)) + 0.0997*cos(q3)*(1.0*cos(q0)*cos(q1)*sin(q2) + 1.0*cos(q0)*cos(q2)*sin(q1)) - 0.3922*cos(q0)*cos(q1)*cos(q2) + 0.3922*cos(q0)*sin(q1)*sin(q2);
...
T(2,4) = 0.0997*cos(q3)*(1.0*cos(q1)*sin(q0)*sin(q2) + 1.0*cos(q2)*sin(q0)*sin(q1)) - 0.0996*cos(q0)*cos(q4) - 0.13333*cos(q0) - 0.425*cos(q1)*sin(q0) - 0.0997*sin(q3)*(1.0*sin(q0)*sin(q1)*sin(q2) - 1.0*cos(q1)*cos(q2)*sin(q0)) + 0.0996*sin(q4)*(1.0*cos(q3)*(1.0*sin(q0)*sin(q1)*sin(q2) - 1.0*cos(q1)*cos(q2)*sin(q0)) + 1.0*sin(q3)*(1.0*cos(q1)*sin(q0)*sin(q2) + 1.0*cos(q2)*sin(q0)*sin(q1))) + 0.3922*sin(q0)*sin(q1)*sin(q2) - 0.3922*cos(q1)*cos(q2)*sin(q0);
...
T(3,4) = 0.0997*sin(q3)*(1.0*cos(q1)*sin(q2) + 1.0*cos(q2)*sin(q1)) - 0.3922*cos(q1)*sin(q2) - 0.3922*cos(q2)*sin(q1) - 0.0996*sin(q4)*(cos(q3)*(1.0*cos(q1)*sin(q2) + 1.0*cos(q2)*sin(q1)) + sin(q3)*(1.0*cos(q1)*cos(q2) - 1.0*sin(q1)*sin(q2))) - 0.0997*cos(q3)*(1.0*cos(q1)*cos(q2) - 1.0*sin(q1)*sin(q2)) - 0.425*sin(q1) + 0.1625;
