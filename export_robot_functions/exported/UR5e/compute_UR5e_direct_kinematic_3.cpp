...
T(0,3) = sin(q0)*1.3333E-1-cos(q0)*cos(q1)*4.25E-1-cos(q0)*cos(q1)*cos(q2)*3.922E-1+cos(q0)*sin(q1)*sin(q2)*3.922E-1;
...
T(1,3) = cos(q0)*-1.3333E-1-cos(q1)*sin(q0)*4.25E-1+sin(q0)*sin(q1)*sin(q2)*3.922E-1-cos(q1)*cos(q2)*sin(q0)*3.922E-1;
