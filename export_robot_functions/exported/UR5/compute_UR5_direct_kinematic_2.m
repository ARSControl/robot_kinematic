function T = compute_UR5_direct_kinematic_2(q)
...
T(1,4) = 0.39225*cos(q0)*sin(q1)*sin(q2) - 0.39225*cos(q0)*cos(q1)*cos(q2) - 0.425*cos(q0)*cos(q1);
...
T(2,4) = 0.39225*sin(q0)*sin(q1)*sin(q2) - 0.425*cos(q1)*sin(q0) - 0.39225*cos(q1)*cos(q2)*sin(q0);
...
T(3,4) = 0.089159 - 0.39225*cos(q1)*sin(q2) - 0.39225*cos(q2)*sin(q1) - 0.425*sin(q1);
