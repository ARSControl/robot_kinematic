...
J(0,0) = cos(q0)*1.0915E-1-cos(q3)*(cos(q1)*sin(q0)*sin(q2)*1.0+cos(q2)*sin(q0)*sin(q1)*1.0)*9.465E-2+cos(q1)*sin(q0)*4.25E-1+sin(q3)*(sin(q0)*sin(q1)*sin(q2)*1.0-cos(q1)*cos(q2)*sin(q0))*9.465E-2-sin(q0)*sin(q1)*sin(q2)*3.9225E-1+cos(q1)*cos(q2)*sin(q0)*3.9225E-1;

J(0,1) = cos(q0)*sin(q1)*4.25E-1-sin(q3)*(cos(q0)*cos(q1)*sin(q2)*1.0+cos(q0)*cos(q2)*sin(q1))*9.465E-2+cos(q3)*(cos(q0)*cos(q1)*cos(q2)*1.0-cos(q0)*sin(q1)*sin(q2)*1.0)*9.465E-2+cos(q0)*cos(q1)*sin(q2)*3.9225E-1+cos(q0)*cos(q2)*sin(q1)*3.9225E-1;

J(0,2) = sin(q3)*(cos(q0)*cos(q1)*sin(q2)+cos(q0)*cos(q2)*sin(q1)*1.0)*-9.465E-2+cos(q3)*(cos(q0)*cos(q1)*cos(q2)*1.0-cos(q0)*sin(q1)*sin(q2)*1.0)*9.465E-2+cos(q0)*cos(q1)*sin(q2)*3.9225E-1+cos(q0)*cos(q2)*sin(q1)*3.9225E-1;

J(0,3) = cos(q3)*(cos(q0)*cos(q1)*cos(q2)-cos(q0)*sin(q1)*sin(q2)*1.0)*9.465E-2-sin(q3)*(cos(q0)*cos(q1)*sin(q2)*1.0+cos(q0)*cos(q2)*sin(q1)*1.0)*9.465E-2;

J(0,4) = 0.0;

J(1,0) = sin(q0)*1.0915E-1-cos(q0)*cos(q1)*4.25E-1+cos(q3)*(cos(q0)*cos(q1)*sin(q2)*1.0+cos(q0)*cos(q2)*sin(q1)*1.0)*9.465E-2+sin(q3)*(cos(q0)*cos(q1)*cos(q2)*1.0-cos(q0)*sin(q1)*sin(q2)*1.0)*9.465E-2-cos(q0)*cos(q1)*cos(q2)*3.9225E-1+cos(q0)*sin(q1)*sin(q2)*3.9225E-1;

J(1,1) = cos(q3)*(sin(q0)*sin(q1)*sin(q2)*1.0-cos(q1)*cos(q2)*sin(q0)*1.0)*-9.465E-2-sin(q3)*(cos(q1)*sin(q0)*sin(q2)*1.0+cos(q2)*sin(q0)*sin(q1)*1.0)*9.465E-2+sin(q0)*sin(q1)*4.25E-1+cos(q1)*sin(q0)*sin(q2)*3.9225E-1+cos(q2)*sin(q0)*sin(q1)*3.9225E-1;

J(1,2) = cos(q3)*(sin(q0)*sin(q1)*sin(q2)*1.0-cos(q1)*cos(q2)*sin(q0)*1.0)*-9.465E-2-sin(q3)*(cos(q1)*sin(q0)*sin(q2)*1.0+cos(q2)*sin(q0)*sin(q1)*1.0)*9.465E-2+cos(q1)*sin(q0)*sin(q2)*3.9225E-1+cos(q2)*sin(q0)*sin(q1)*3.9225E-1;

J(1,3) = cos(q3)*(sin(q0)*sin(q1)*sin(q2)*1.0-cos(q1)*cos(q2)*sin(q0)*1.0)*-9.465E-2-sin(q3)*(cos(q1)*sin(q0)*sin(q2)*1.0+cos(q2)*sin(q0)*sin(q1)*1.0)*9.465E-2;

J(1,4) = 0.0;

J(2,0) = 0.0;

J(2,1) = cos(q1)*-4.25E-1-cos(q1)*cos(q2)*3.9225E-1+sin(q1)*sin(q2)*3.9225E-1+cos(q3)*(cos(q1)*sin(q2)*1.0+cos(q2)*sin(q1)*1.0)*9.465E-2+sin(q3)*(cos(q1)*cos(q2)*1.0-sin(q1)*sin(q2)*1.0)*9.465E-2;

J(2,2) = cos(q1)*cos(q2)*-3.9225E-1+sin(q1)*sin(q2)*3.9225E-1+cos(q3)*(cos(q1)*sin(q2)*1.0+cos(q2)*sin(q1)*1.0)*9.465E-2+sin(q3)*(cos(q1)*cos(q2)*1.0-sin(q1)*sin(q2)*1.0)*9.465E-2;

J(2,3) = cos(q3)*(cos(q1)*sin(q2)*1.0+cos(q2)*sin(q1)*1.0)*9.465E-2+sin(q3)*(cos(q1)*cos(q2)*1.0-sin(q1)*sin(q2)*1.0)*9.465E-2;
