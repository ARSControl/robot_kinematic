function J_dot = compute_UR5_jacobian_dot_2(q, dq)
...
J_dot(1,1) = 0.425*dq0*cos(q0)*cos(q1) - 0.425*dq1*sin(q0)*sin(q1) + 0.39225*dq0*cos(q0)*cos(q1)*cos(q2) - 0.39225*dq0*cos(q0)*sin(q1)*sin(q2) - 0.39225*dq1*cos(q1)*sin(q0)*sin(q2) - 0.39225*dq1*cos(q2)*sin(q0)*sin(q1) - 0.39225*dq2*cos(q1)*sin(q0)*sin(q2) - 0.39225*dq2*cos(q2)*sin(q0)*sin(q1);

J_dot(1,2) = 0.425*dq1*cos(q0)*cos(q1) - 0.425*dq0*sin(q0)*sin(q1) + 0.39225*dq1*cos(q0)*cos(q1)*cos(q2) + 0.39225*dq2*cos(q0)*cos(q1)*cos(q2) - 0.39225*dq0*cos(q1)*sin(q0)*sin(q2) - 0.39225*dq0*cos(q2)*sin(q0)*sin(q1) - 0.39225*dq1*cos(q0)*sin(q1)*sin(q2) - 0.39225*dq2*cos(q0)*sin(q1)*sin(q2);

J_dot(1,3) = 0.39225*dq1*cos(q0)*cos(q1)*cos(q2) + 0.39225*dq2*cos(q0)*cos(q1)*cos(q2) - 0.39225*dq0*cos(q1)*sin(q0)*sin(q2) - 0.39225*dq0*cos(q2)*sin(q0)*sin(q1) - 0.39225*dq1*cos(q0)*sin(q1)*sin(q2) - 0.39225*dq2*cos(q0)*sin(q1)*sin(q2);

J_dot(2,1) = 0.425*dq0*cos(q1)*sin(q0) + 0.425*dq1*cos(q0)*sin(q1) + 0.39225*dq0*cos(q1)*cos(q2)*sin(q0) + 0.39225*dq1*cos(q0)*cos(q1)*sin(q2) + 0.39225*dq1*cos(q0)*cos(q2)*sin(q1) + 0.39225*dq2*cos(q0)*cos(q1)*sin(q2) + 0.39225*dq2*cos(q0)*cos(q2)*sin(q1) - 0.39225*dq0*sin(q0)*sin(q1)*sin(q2);

J_dot(2,2) = 0.425*dq0*cos(q0)*sin(q1) + 0.425*dq1*cos(q1)*sin(q0) + 0.39225*dq0*cos(q0)*cos(q1)*sin(q2) + 0.39225*dq0*cos(q0)*cos(q2)*sin(q1) + 0.39225*dq1*cos(q1)*cos(q2)*sin(q0) + 0.39225*dq2*cos(q1)*cos(q2)*sin(q0) - 0.39225*dq1*sin(q0)*sin(q1)*sin(q2) - 0.39225*dq2*sin(q0)*sin(q1)*sin(q2);

J_dot(2,3) = 0.39225*dq0*cos(q0)*cos(q1)*sin(q2) + 0.39225*dq0*cos(q0)*cos(q2)*sin(q1) + 0.39225*dq1*cos(q1)*cos(q2)*sin(q0) + 0.39225*dq2*cos(q1)*cos(q2)*sin(q0) - 0.39225*dq1*sin(q0)*sin(q1)*sin(q2) - 0.39225*dq2*sin(q0)*sin(q1)*sin(q2);

J_dot(3,1) = 0;

J_dot(3,2) = 0.425*dq1*sin(q1) + 0.39225*dq1*cos(q1)*sin(q2) + 0.39225*dq1*cos(q2)*sin(q1) + 0.39225*dq2*cos(q1)*sin(q2) + 0.39225*dq2*cos(q2)*sin(q1);

J_dot(3,3) = 0.39225*dq1*cos(q1)*sin(q2) + 0.39225*dq1*cos(q2)*sin(q1) + 0.39225*dq2*cos(q1)*sin(q2) + 0.39225*dq2*cos(q2)*sin(q1);
