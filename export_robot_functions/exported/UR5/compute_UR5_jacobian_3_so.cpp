...
// Eigen::Matrix<double, 6, 6> compute_UR5_jacobian_3(Eigen::Matrix<double, 6, 1> q){
extern "C" void compute_UR5_jacobian_3(double* result, double *q) {
...
J(0,0) = cos(q0)*1.0915E-1+cos(q1)*sin(q0)*4.25E-1-sin(q0)*sin(q1)*sin(q2)*3.9225E-1+cos(q1)*cos(q2)*sin(q0)*3.9225E-1;

J(0,1) = cos(q0)*sin(q1)*4.25E-1+cos(q0)*cos(q1)*sin(q2)*3.9225E-1+cos(q0)*cos(q2)*sin(q1)*3.9225E-1;

J(0,2) = cos(q0)*cos(q1)*sin(q2)*3.9225E-1+cos(q0)*cos(q2)*sin(q1)*3.9225E-1;

J(0,3) = 0.0;

J(1,0) = sin(q0)*1.0915E-1-cos(q0)*cos(q1)*4.25E-1-cos(q0)*cos(q1)*cos(q2)*3.9225E-1+cos(q0)*sin(q1)*sin(q2)*3.9225E-1;

J(1,1) = sin(q0)*sin(q1)*4.25E-1+cos(q1)*sin(q0)*sin(q2)*3.9225E-1+cos(q2)*sin(q0)*sin(q1)*3.9225E-1;

J(1,2) = cos(q1)*sin(q0)*sin(q2)*3.9225E-1+cos(q2)*sin(q0)*sin(q1)*3.9225E-1;

J(1,3) = 0.0;

J(2,0) = 0.0;

J(2,1) = cos(q1)*-4.25E-1-cos(q1)*cos(q2)*3.9225E-1+sin(q1)*sin(q2)*3.9225E-1;

J(2,2) = cos(q1)*cos(q2)*-3.9225E-1+sin(q1)*sin(q2)*3.9225E-1;
