...
extern "C" void compute_UR5_jacobian_2(double* result, double *q) {
...
J(0,0) = cos(q1)*sin(q0)*4.25E-1-sin(q0)*sin(q1)*sin(q2)*3.9225E-1+cos(q1)*cos(q2)*sin(q0)*3.9225E-1;
...
J(1,0) = cos(q0)*cos(q1)*-4.25E-1-cos(q0)*cos(q1)*cos(q2)*3.9225E-1+cos(q0)*sin(q1)*sin(q2)*3.9225E-1;
