...
T(1,4) = 0.10915*sin(q0) + 0.09465*sin(q1 + q2 + q3)*cos(q0) - 0.00025*cos(q0)*(1569.0*cos(q1 + q2) + 1700.0*cos(q1));
...
T(2,4) = 0.09465*sin(q1 + q2 + q3)*sin(q0) - 0.10915*cos(q0) - 0.00025*sin(q0)*(1569.0*cos(q1 + q2) + 1700.0*cos(q1));
...
T(3,4) = 0.089159 - 0.39225*sin(q1 + q2) - 0.425*sin(q1) - 0.09465*cos(q1 + q2 + q3);
