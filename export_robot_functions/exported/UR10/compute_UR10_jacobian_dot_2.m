function J_dot = compute_UR10_jacobian_dot_2(q, dq)
...
J_dot(1,1) = 0.612*dq0*cos(q0)*cos(q1) - 0.612*dq1*sin(q0)*sin(q1) + 0.5723*dq0*cos(q0)*cos(q1)*cos(q2) - 0.5723*dq0*cos(q0)*sin(q1)*sin(q2) - 0.5723*dq1*cos(q1)*sin(q0)*sin(q2) - 0.5723*dq1*cos(q2)*sin(q0)*sin(q1) - 0.5723*dq2*cos(q1)*sin(q0)*sin(q2) - 0.5723*dq2*cos(q2)*sin(q0)*sin(q1);

J_dot(1,2) = 0.612*dq1*cos(q0)*cos(q1) - 0.612*dq0*sin(q0)*sin(q1) + 0.5723*dq1*cos(q0)*cos(q1)*cos(q2) + 0.5723*dq2*cos(q0)*cos(q1)*cos(q2) - 0.5723*dq0*cos(q1)*sin(q0)*sin(q2) - 0.5723*dq0*cos(q2)*sin(q0)*sin(q1) - 0.5723*dq1*cos(q0)*sin(q1)*sin(q2) - 0.5723*dq2*cos(q0)*sin(q1)*sin(q2);

J_dot(1,3) = 0.5723*dq1*cos(q0)*cos(q1)*cos(q2) + 0.5723*dq2*cos(q0)*cos(q1)*cos(q2) - 0.5723*dq0*cos(q1)*sin(q0)*sin(q2) - 0.5723*dq0*cos(q2)*sin(q0)*sin(q1) - 0.5723*dq1*cos(q0)*sin(q1)*sin(q2) - 0.5723*dq2*cos(q0)*sin(q1)*sin(q2);

J_dot(2,1) = 0.612*dq0*cos(q1)*sin(q0) + 0.612*dq1*cos(q0)*sin(q1) + 0.5723*dq0*cos(q1)*cos(q2)*sin(q0) + 0.5723*dq1*cos(q0)*cos(q1)*sin(q2) + 0.5723*dq1*cos(q0)*cos(q2)*sin(q1) + 0.5723*dq2*cos(q0)*cos(q1)*sin(q2) + 0.5723*dq2*cos(q0)*cos(q2)*sin(q1) - 0.5723*dq0*sin(q0)*sin(q1)*sin(q2);

J_dot(2,2) = 0.612*dq0*cos(q0)*sin(q1) + 0.612*dq1*cos(q1)*sin(q0) + 0.5723*dq0*cos(q0)*cos(q1)*sin(q2) + 0.5723*dq0*cos(q0)*cos(q2)*sin(q1) + 0.5723*dq1*cos(q1)*cos(q2)*sin(q0) + 0.5723*dq2*cos(q1)*cos(q2)*sin(q0) - 0.5723*dq1*sin(q0)*sin(q1)*sin(q2) - 0.5723*dq2*sin(q0)*sin(q1)*sin(q2);

J_dot(2,3) = 0.5723*dq0*cos(q0)*cos(q1)*sin(q2) + 0.5723*dq0*cos(q0)*cos(q2)*sin(q1) + 0.5723*dq1*cos(q1)*cos(q2)*sin(q0) + 0.5723*dq2*cos(q1)*cos(q2)*sin(q0) - 0.5723*dq1*sin(q0)*sin(q1)*sin(q2) - 0.5723*dq2*sin(q0)*sin(q1)*sin(q2);

J_dot(3,1) = 0;

J_dot(3,2) = 0.612*dq1*sin(q1) + 0.5723*dq1*cos(q1)*sin(q2) + 0.5723*dq1*cos(q2)*sin(q1) + 0.5723*dq2*cos(q1)*sin(q2) + 0.5723*dq2*cos(q2)*sin(q1);

J_dot(3,3) = 0.5723*dq1*cos(q1)*sin(q2) + 0.5723*dq1*cos(q2)*sin(q1) + 0.5723*dq2*cos(q1)*sin(q2) + 0.5723*dq2*cos(q2)*sin(q1);
