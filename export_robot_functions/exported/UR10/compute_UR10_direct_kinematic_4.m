...
T(1,4) = 0.163941*sin(q0) + 0.1157*sin(q1 + q2 + q3)*cos(q0) - 0.0001*cos(q0)*(5723.0*cos(q1 + q2) + 6120.0*cos(q1));
...
T(2,4) = 0.1157*sin(q1 + q2 + q3)*sin(q0) - 0.163941*cos(q0) - 0.0001*sin(q0)*(5723.0*cos(q1 + q2) + 6120.0*cos(q1));
...
T(3,4) = 0.1273 - 0.5723*sin(q1 + q2) - 0.612*sin(q1) - 0.1157*cos(q1 + q2 + q3);
