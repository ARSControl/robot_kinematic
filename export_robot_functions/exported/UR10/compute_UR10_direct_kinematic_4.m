function T = compute_UR10_direct_kinematic_4(q)
...
T(1,4) = 0.163941*sin(q0) - 0.612*cos(q0)*cos(q1) + 0.1157*sin(q3)*(cos(q0)*cos(q1)*cos(q2) - 1.0*cos(q0)*sin(q1)*sin(q2)) + 0.1157*cos(q3)*(1.0*cos(q0)*cos(q1)*sin(q2) + 1.0*cos(q0)*cos(q2)*sin(q1)) - 0.5723*cos(q0)*cos(q1)*cos(q2) + 0.5723*cos(q0)*sin(q1)*sin(q2);
...
T(2,4) = 0.1157*cos(q3)*(1.0*cos(q1)*sin(q0)*sin(q2) + 1.0*cos(q2)*sin(q0)*sin(q1)) - 0.163941*cos(q0) - 0.612*cos(q1)*sin(q0) - 0.1157*sin(q3)*(1.0*sin(q0)*sin(q1)*sin(q2) - 1.0*cos(q1)*cos(q2)*sin(q0)) + 0.5723*sin(q0)*sin(q1)*sin(q2) - 0.5723*cos(q1)*cos(q2)*sin(q0);
...
T(3,4) = 0.1157*sin(q3)*(1.0*cos(q1)*sin(q2) + 1.0*cos(q2)*sin(q1)) - 0.5723*cos(q1)*sin(q2) - 0.5723*cos(q2)*sin(q1) - 0.1157*cos(q3)*(1.0*cos(q1)*cos(q2) - 1.0*sin(q1)*sin(q2)) - 0.612*sin(q1) + 0.1273;
