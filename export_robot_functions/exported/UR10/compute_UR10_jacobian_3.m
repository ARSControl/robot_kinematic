...
J(1,1) = 0.163941*cos(q0) + 0.612*cos(q1)*sin(q0) - 0.5723*sin(q0)*sin(q1)*sin(q2) + 0.5723*cos(q1)*cos(q2)*sin(q0);
...
J(2,1) = 0.163941*sin(q0) - 0.612*cos(q0)*cos(q1) - 0.5723*cos(q0)*cos(q1)*cos(q2) + 0.5723*cos(q0)*sin(q1)*sin(q2);
