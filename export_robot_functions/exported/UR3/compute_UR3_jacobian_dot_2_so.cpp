...
extern "C" void compute_UR3_jacobian_dot_2(double* result, double *q, double *dq) {
...
J_dot(0,0) = dq0*cos(q0)*cos(q1)*2.4365E-1-dq1*sin(q0)*sin(q1)*2.4365E-1+dq0*cos(q0)*cos(q1)*cos(q2)*2.1325E-1-dq0*cos(q0)*sin(q1)*sin(q2)*2.1325E-1-dq1*cos(q1)*sin(q0)*sin(q2)*2.1325E-1-dq1*cos(q2)*sin(q0)*sin(q1)*2.1325E-1-dq2*cos(q1)*sin(q0)*sin(q2)*2.1325E-1-dq2*cos(q2)*sin(q0)*sin(q1)*2.1325E-1;

J_dot(0,1) = dq1*cos(q0)*cos(q1)*2.4365E-1-dq0*sin(q0)*sin(q1)*2.4365E-1+dq1*cos(q0)*cos(q1)*cos(q2)*2.1325E-1+dq2*cos(q0)*cos(q1)*cos(q2)*2.1325E-1-dq0*cos(q1)*sin(q0)*sin(q2)*2.1325E-1-dq0*cos(q2)*sin(q0)*sin(q1)*2.1325E-1-dq1*cos(q0)*sin(q1)*sin(q2)*2.1325E-1-dq2*cos(q0)*sin(q1)*sin(q2)*2.1325E-1;

J_dot(0,2) = dq1*cos(q0)*cos(q1)*cos(q2)*2.1325E-1+dq2*cos(q0)*cos(q1)*cos(q2)*2.1325E-1-dq0*cos(q1)*sin(q0)*sin(q2)*2.1325E-1-dq0*cos(q2)*sin(q0)*sin(q1)*2.1325E-1-dq1*cos(q0)*sin(q1)*sin(q2)*2.1325E-1-dq2*cos(q0)*sin(q1)*sin(q2)*2.1325E-1;

J_dot(1,0) = dq0*cos(q1)*sin(q0)*2.4365E-1+dq1*cos(q0)*sin(q1)*2.4365E-1+dq0*cos(q1)*cos(q2)*sin(q0)*2.1325E-1+dq1*cos(q0)*cos(q1)*sin(q2)*2.1325E-1+dq1*cos(q0)*cos(q2)*sin(q1)*2.1325E-1+dq2*cos(q0)*cos(q1)*sin(q2)*2.1325E-1+dq2*cos(q0)*cos(q2)*sin(q1)*2.1325E-1-dq0*sin(q0)*sin(q1)*sin(q2)*2.1325E-1;

J_dot(1,1) = dq0*cos(q0)*sin(q1)*2.4365E-1+dq1*cos(q1)*sin(q0)*2.4365E-1+dq0*cos(q0)*cos(q1)*sin(q2)*2.1325E-1+dq0*cos(q0)*cos(q2)*sin(q1)*2.1325E-1+dq1*cos(q1)*cos(q2)*sin(q0)*2.1325E-1+dq2*cos(q1)*cos(q2)*sin(q0)*2.1325E-1-dq1*sin(q0)*sin(q1)*sin(q2)*2.1325E-1-dq2*sin(q0)*sin(q1)*sin(q2)*2.1325E-1;

J_dot(1,2) = dq0*cos(q0)*cos(q1)*sin(q2)*2.1325E-1+dq0*cos(q0)*cos(q2)*sin(q1)*2.1325E-1+dq1*cos(q1)*cos(q2)*sin(q0)*2.1325E-1+dq2*cos(q1)*cos(q2)*sin(q0)*2.1325E-1-dq1*sin(q0)*sin(q1)*sin(q2)*2.1325E-1-dq2*sin(q0)*sin(q1)*sin(q2)*2.1325E-1;

J_dot(2,0) = 0.0;

J_dot(2,1) = dq1*sin(q1)*2.4365E-1+dq1*cos(q1)*sin(q2)*2.1325E-1+dq1*cos(q2)*sin(q1)*2.1325E-1+dq2*cos(q1)*sin(q2)*2.1325E-1+dq2*cos(q2)*sin(q1)*2.1325E-1;

J_dot(2,2) = dq1*cos(q1)*sin(q2)*2.1325E-1+dq1*cos(q2)*sin(q1)*2.1325E-1+dq2*cos(q1)*sin(q2)*2.1325E-1+dq2*cos(q2)*sin(q1)*2.1325E-1;
