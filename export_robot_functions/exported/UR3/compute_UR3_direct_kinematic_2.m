...
T(1,4) = 0.21325*cos(q0)*sin(q1)*sin(q2) - 0.21325*cos(q0)*cos(q1)*cos(q2) - 0.24365*cos(q0)*cos(q1);
...
T(2,4) = 0.21325*sin(q0)*sin(q1)*sin(q2) - 0.24365*cos(q1)*sin(q0) - 0.21325*cos(q1)*cos(q2)*sin(q0);
