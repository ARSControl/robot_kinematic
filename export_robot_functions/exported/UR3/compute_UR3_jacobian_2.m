function J = compute_UR3_jacobian_2(q)
...
J(1,1) = 0.24365*cos(q1)*sin(q0) - 0.21325*sin(q0)*sin(q1)*sin(q2) + 0.21325*cos(q1)*cos(q2)*sin(q0);
...
J(2,1) = 0.21325*cos(q0)*sin(q1)*sin(q2) - 0.21325*cos(q0)*cos(q1)*cos(q2) - 0.24365*cos(q0)*cos(q1);
