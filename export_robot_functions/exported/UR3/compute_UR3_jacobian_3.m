function J = compute_UR3_jacobian_3(q)
...
J(1,1) = 0.11235*cos(q0) + 0.24365*cos(q1)*sin(q0) - 0.21325*sin(q0)*sin(q1)*sin(q2) + 0.21325*cos(q1)*cos(q2)*sin(q0);

J(1,2) = 0.24365*cos(q0)*sin(q1) + 0.21325*cos(q0)*cos(q1)*sin(q2) + 0.21325*cos(q0)*cos(q2)*sin(q1);

J(1,3) = 0.21325*cos(q0)*cos(q1)*sin(q2) + 0.21325*cos(q0)*cos(q2)*sin(q1);

J(1,4) = 0;

J(2,1) = 0.11235*sin(q0) - 0.24365*cos(q0)*cos(q1) - 0.21325*cos(q0)*cos(q1)*cos(q2) + 0.21325*cos(q0)*sin(q1)*sin(q2);

J(2,2) = 0.24365*sin(q0)*sin(q1) + 0.21325*cos(q1)*sin(q0)*sin(q2) + 0.21325*cos(q2)*sin(q0)*sin(q1);

J(2,3) = 0.21325*cos(q1)*sin(q0)*sin(q2) + 0.21325*cos(q2)*sin(q0)*sin(q1);

J(2,4) = 0;

J(3,1) = 0;

J(3,2) = 0.21325*sin(q1)*sin(q2) - 0.21325*cos(q1)*cos(q2) - 0.24365*cos(q1);

J(3,3) = 0.21325*sin(q1)*sin(q2) - 0.21325*cos(q1)*cos(q2);
