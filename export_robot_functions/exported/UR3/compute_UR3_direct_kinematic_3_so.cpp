...
extern "C" void compute_UR3_direct_kinematic_3(double* result, double *q) {
...
T(0,3) = sin(q0)*1.1235E-1-cos(q0)*cos(q1)*2.4365E-1-cos(q0)*cos(q1)*cos(q2)*2.1325E-1+cos(q0)*sin(q1)*sin(q2)*2.1325E-1;
...
T(1,3) = cos(q0)*-1.1235E-1-cos(q1)*sin(q0)*2.4365E-1+sin(q0)*sin(q1)*sin(q2)*2.1325E-1-cos(q1)*cos(q2)*sin(q0)*2.1325E-1;
