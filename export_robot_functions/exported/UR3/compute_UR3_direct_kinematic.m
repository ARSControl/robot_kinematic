function T = compute_UR3_direct_kinematic(q)
...
T(1,4) = 0.11235*sin(q0) - 0.24365*cos(q0)*cos(q1) + 0.0819*cos(q4)*sin(q0) - 0.0819*sin(q4)*(cos(q3)*(cos(q0)*cos(q1)*cos(q2) - 1.0*cos(q0)*sin(q1)*sin(q2)) - 1.0*sin(q3)*(1.0*cos(q0)*cos(q1)*sin(q2) + 1.0*cos(q0)*cos(q2)*sin(q1))) + 0.08535*sin(q3)*(cos(q0)*cos(q1)*cos(q2) - 1.0*cos(q0)*sin(q1)*sin(q2)) + 0.08535*cos(q3)*(1.0*cos(q0)*cos(q1)*sin(q2) + 1.0*cos(q0)*cos(q2)*sin(q1)) - 0.21325*cos(q0)*cos(q1)*cos(q2) + 0.21325*cos(q0)*sin(q1)*sin(q2);
...
T(2,4) = 0.08535*cos(q3)*(1.0*cos(q1)*sin(q0)*sin(q2) + 1.0*cos(q2)*sin(q0)*sin(q1)) - 0.0819*cos(q0)*cos(q4) - 0.11235*cos(q0) - 0.24365*cos(q1)*sin(q0) - 0.08535*sin(q3)*(1.0*sin(q0)*sin(q1)*sin(q2) - 1.0*cos(q1)*cos(q2)*sin(q0)) + 0.0819*sin(q4)*(1.0*cos(q3)*(1.0*sin(q0)*sin(q1)*sin(q2) - 1.0*cos(q1)*cos(q2)*sin(q0)) + 1.0*sin(q3)*(1.0*cos(q1)*sin(q0)*sin(q2) + 1.0*cos(q2)*sin(q0)*sin(q1))) + 0.21325*sin(q0)*sin(q1)*sin(q2) - 0.21325*cos(q1)*cos(q2)*sin(q0);
...
T(3,4) = 0.08535*sin(q3)*(1.0*cos(q1)*sin(q2) + 1.0*cos(q2)*sin(q1)) - 0.21325*cos(q1)*sin(q2) - 0.21325*cos(q2)*sin(q1) - 0.0819*sin(q4)*(cos(q3)*(1.0*cos(q1)*sin(q2) + 1.0*cos(q2)*sin(q1)) + sin(q3)*(1.0*cos(q1)*cos(q2) - 1.0*sin(q1)*sin(q2))) - 0.08535*cos(q3)*(1.0*cos(q1)*cos(q2) - 1.0*sin(q1)*sin(q2)) - 0.24365*sin(q1) + 0.1519;
