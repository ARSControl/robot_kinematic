...
T(1,4) = 0.11235*sin(q0) + 0.0819*cos(q4)*sin(q0) + 0.08535*sin(q1 + q2 + q3)*cos(q0) - 0.00005*cos(q0)*(4265.0*cos(q1 + q2) + 4873.0*cos(q1)) - 0.0819*cos(q1 + q2 + q3)*cos(q0)*sin(q4);
...
T(2,4) = 0.08535*sin(q1 + q2 + q3)*sin(q0) - 0.0819*cos(q0)*cos(q4) - 0.11235*cos(q0) - 0.00005*sin(q0)*(4265.0*cos(q1 + q2) + 4873.0*cos(q1)) - 0.0819*cos(q1 + q2 + q3)*sin(q0)*sin(q4);
...
T(3,4) = 0.1519 - 0.21325*sin(q1 + q2) - 0.24365*sin(q1) - 0.0819*sin(q1 + q2 + q3)*sin(q4) - 0.08535*cos(q1 + q2 + q3);
