function J_dot = compute_UR3_jacobian_dot(q, dq)
...
J_dot(1,1) = 0.00005*dq0*cos(q0)*(4265.0*cos(q1 + q2) + 4873.0*cos(q1)) - 0.11235*dq0*sin(q0) - 0.0819*dq0*cos(q4)*sin(q0) - 0.0819*dq4*cos(q0)*sin(q4) - 0.08535*dq0*sin(q1 + q2 + q3)*cos(q0) - 0.00005*sin(q0)*(4265.0*sin(q1 + q2)*(dq1 + dq2) + 4873.0*dq1*sin(q1)) - 0.08535*cos(q1 + q2 + q3)*sin(q0)*(dq1 + dq2 + dq3) + 0.0819*dq0*cos(q1 + q2 + q3)*cos(q0)*sin(q4) + 0.0819*dq4*cos(q1 + q2 + q3)*cos(q4)*sin(q0) - 0.0819*sin(q1 + q2 + q3)*sin(q0)*sin(q4)*(dq1 + dq2 + dq3);

J_dot(1,2) = (cos(q0)*(4265.0*cos(q1 + q2)*(dq1 + dq2) - 1707.0*sin(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 4873.0*dq1*cos(q1) + 1638.0*dq4*sin(q1 + q2 + q3)*cos(q4) + 1638.0*cos(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3)))/20000 - (dq0*sin(q0)*(1707.0*cos(q1 + q2 + q3) + 4265.0*sin(q1 + q2) + 4873.0*sin(q1) + 1638.0*sin(q1 + q2 + q3)*sin(q4)))/20000;

J_dot(1,3) = (cos(q0)*(4265.0*cos(q1 + q2)*(dq1 + dq2) - 1707.0*sin(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 1638.0*dq4*sin(q1 + q2 + q3)*cos(q4) + 1638.0*cos(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3)))/20000 - (dq0*sin(q0)*(1707.0*cos(q1 + q2 + q3) + 4265.0*sin(q1 + q2) + 1638.0*sin(q1 + q2 + q3)*sin(q4)))/20000;

J_dot(1,4) = (3*cos(q0)*(546.0*dq4*sin(q1 + q2 + q3)*cos(q4) - 569.0*sin(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 546.0*cos(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3)))/20000 - (3*dq0*sin(q0)*(569.0*cos(q1 + q2 + q3) + 546.0*sin(q1 + q2 + q3)*sin(q4)))/20000;

J_dot(1,5) = 0.0819*dq0*cos(q1 + q2 + q3)*cos(q4)*sin(q0) - 0.0819*dq4*cos(q4)*sin(q0) - 0.0819*dq0*cos(q0)*sin(q4) + 0.0819*dq4*cos(q1 + q2 + q3)*cos(q0)*sin(q4) + 0.0819*sin(q1 + q2 + q3)*cos(q0)*cos(q4)*(dq1 + dq2 + dq3);

J_dot(1,6) = 0;

J_dot(2,1) = 0.00005*cos(q0)*(4265.0*sin(q1 + q2)*(dq1 + dq2) + 4873.0*dq1*sin(q1)) + 0.11235*dq0*cos(q0) + 0.0819*dq0*cos(q0)*cos(q4) - 0.0819*dq4*sin(q0)*sin(q4) - 0.08535*dq0*sin(q1 + q2 + q3)*sin(q0) + 0.00005*dq0*sin(q0)*(4265.0*cos(q1 + q2) + 4873.0*cos(q1)) + 0.08535*cos(q1 + q2 + q3)*cos(q0)*(dq1 + dq2 + dq3) - 0.0819*dq4*cos(q1 + q2 + q3)*cos(q0)*cos(q4) + 0.0819*dq0*cos(q1 + q2 + q3)*sin(q0)*sin(q4) + 0.0819*sin(q1 + q2 + q3)*cos(q0)*sin(q4)*(dq1 + dq2 + dq3);

J_dot(2,2) = (sin(q0)*(4265.0*cos(q1 + q2)*(dq1 + dq2) - 1707.0*sin(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 4873.0*dq1*cos(q1) + 1638.0*dq4*sin(q1 + q2 + q3)*cos(q4) + 1638.0*cos(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3)))/20000 + (dq0*cos(q0)*(1707.0*cos(q1 + q2 + q3) + 4265.0*sin(q1 + q2) + 4873.0*sin(q1) + 1638.0*sin(q1 + q2 + q3)*sin(q4)))/20000;

J_dot(2,3) = (sin(q0)*(4265.0*cos(q1 + q2)*(dq1 + dq2) - 1707.0*sin(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 1638.0*dq4*sin(q1 + q2 + q3)*cos(q4) + 1638.0*cos(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3)))/20000 + (dq0*cos(q0)*(1707.0*cos(q1 + q2 + q3) + 4265.0*sin(q1 + q2) + 1638.0*sin(q1 + q2 + q3)*sin(q4)))/20000;

J_dot(2,4) = (3*sin(q0)*(546.0*dq4*sin(q1 + q2 + q3)*cos(q4) - 569.0*sin(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 546.0*cos(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3)))/20000 + (3*dq0*cos(q0)*(569.0*cos(q1 + q2 + q3) + 546.0*sin(q1 + q2 + q3)*sin(q4)))/20000;

J_dot(2,5) = 0.0819*dq4*cos(q0)*cos(q4) - 0.0819*dq0*sin(q0)*sin(q4) - 0.0819*dq0*cos(q1 + q2 + q3)*cos(q0)*cos(q4) + 0.0819*dq4*cos(q1 + q2 + q3)*sin(q0)*sin(q4) + 0.0819*sin(q1 + q2 + q3)*cos(q4)*sin(q0)*(dq1 + dq2 + dq3);

J_dot(2,6) = 0;

J_dot(3,1) = 0;

J_dot(3,2) = 0.08535*cos(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 0.21325*sin(q1 + q2)*(dq1 + dq2) + 0.24365*dq1*sin(q1) - 0.0819*dq4*cos(q1 + q2 + q3)*cos(q4) + 0.0819*sin(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3);

J_dot(3,3) = 0.08535*cos(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 0.21325*sin(q1 + q2)*(dq1 + dq2) - 0.0819*dq4*cos(q1 + q2 + q3)*cos(q4) + 0.0819*sin(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3);

J_dot(3,4) = 0.08535*cos(q1 + q2 + q3)*(dq1 + dq2 + dq3) - 0.0819*dq4*cos(q1 + q2 + q3)*cos(q4) + 0.0819*sin(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3);

J_dot(3,5) = 0.0819*dq4*sin(q1 + q2 + q3)*sin(q4) - 0.0819*cos(q1 + q2 + q3)*cos(q4)*(dq1 + dq2 + dq3);
