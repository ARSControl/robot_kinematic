function J = compute_UR16e_jacobian_3(q)
...
J(1,1) = 0.17415*cos(q0) + 0.4784*cos(q1)*sin(q0) - 0.36*sin(q0)*sin(q1)*sin(q2) + 0.36*cos(q1)*cos(q2)*sin(q0);

J(1,2) = 0.4784*cos(q0)*sin(q1) + 0.36*cos(q0)*cos(q1)*sin(q2) + 0.36*cos(q0)*cos(q2)*sin(q1);

J(1,3) = 0.36*cos(q0)*cos(q1)*sin(q2) + 0.36*cos(q0)*cos(q2)*sin(q1);

J(1,4) = 0;

J(2,1) = 0.17415*sin(q0) - 0.4784*cos(q0)*cos(q1) - 0.36*cos(q0)*cos(q1)*cos(q2) + 0.36*cos(q0)*sin(q1)*sin(q2);

J(2,2) = 0.4784*sin(q0)*sin(q1) + 0.36*cos(q1)*sin(q0)*sin(q2) + 0.36*cos(q2)*sin(q0)*sin(q1);

J(2,3) = 0.36*cos(q1)*sin(q0)*sin(q2) + 0.36*cos(q2)*sin(q0)*sin(q1);

J(2,4) = 0;

J(3,1) = 0;

J(3,2) = 0.36*sin(q1)*sin(q2) - 0.36*cos(q1)*cos(q2) - 0.4784*cos(q1);

J(3,3) = 0.36*sin(q1)*sin(q2) - 0.36*cos(q1)*cos(q2);
