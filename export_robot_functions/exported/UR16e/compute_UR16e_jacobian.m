function J = compute_UR16e_jacobian(q)
...
J(1,1) = 0.17415*cos(q0) + 0.11655*cos(q0)*cos(q4) - 0.11985*sin(q1 + q2 + q3)*sin(q0) + 0.0016*sin(q0)*(225.0*cos(q1 + q2) + 299.0*cos(q1)) + 0.11655*cos(q1 + q2 + q3)*sin(q0)*sin(q4);

J(1,2) = (cos(q0)*(2397.0*cos(q1 + q2 + q3) + 7200.0*sin(q1 + q2) + 9568.0*sin(q1) + 2331.0*sin(q1 + q2 + q3)*sin(q4)))/20000;

J(1,3) = (3*cos(q0)*(799.0*cos(q1 + q2 + q3) + 2400.0*sin(q1 + q2) + 777.0*sin(q1 + q2 + q3)*sin(q4)))/20000;
...
J(2,1) = 0.17415*sin(q0) + 0.11655*cos(q4)*sin(q0) + 0.11985*sin(q1 + q2 + q3)*cos(q0) - 0.0016*cos(q0)*(225.0*cos(q1 + q2) + 299.0*cos(q1)) - 0.11655*cos(q1 + q2 + q3)*cos(q0)*sin(q4);

J(2,2) = (sin(q0)*(2397.0*cos(q1 + q2 + q3) + 7200.0*sin(q1 + q2) + 9568.0*sin(q1) + 2331.0*sin(q1 + q2 + q3)*sin(q4)))/20000;

J(2,3) = (3*sin(q0)*(799.0*cos(q1 + q2 + q3) + 2400.0*sin(q1 + q2) + 777.0*sin(q1 + q2 + q3)*sin(q4)))/20000;
...
J(3,2) = 0.11985*sin(q1 + q2 + q3) - 0.36*cos(q1 + q2) - 0.4784*cos(q1) - 0.11655*cos(q1 + q2 + q3)*sin(q4);

J(3,3) = 0.11985*sin(q1 + q2 + q3) - 0.36*cos(q1 + q2) - 0.11655*cos(q1 + q2 + q3)*sin(q4);
