...
J(0,0) = cos(q0)*1.7415E-1+sin(q0)*(cos(q1+q2)*2.25E+2+cos(q1)*2.99E+2)*1.6E-3;

J(0,1) = cos(q0)*(sin(q1+q2)*2.25E+2+sin(q1)*2.99E+2)*1.6E-3;

J(0,2) = sin(q1+q2)*cos(q0)*3.6E-1;

J(0,3) = 0.0;

J(1,0) = sin(q0)*1.7415E-1-cos(q0)*(cos(q1+q2)*2.25E+2+cos(q1)*2.99E+2)*1.6E-3;

J(1,1) = sin(q0)*(sin(q1+q2)*2.25E+2+sin(q1)*2.99E+2)*1.6E-3;
