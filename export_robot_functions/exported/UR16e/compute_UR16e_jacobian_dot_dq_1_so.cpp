...
extern "C" void compute_UR16e_jacobian_dot_dq_1(double* result, double *q, double *dq) {
...
J_dot_dq(0,0) = dq0*(dq0*cos(q0)*cos(q1)*4.784E-1-dq1*sin(q0)*sin(q1)*4.784E-1)+dq1*(dq1*cos(q0)*cos(q1)*4.784E-1-dq0*sin(q0)*sin(q1)*4.784E-1);

J_dot_dq(1,0) = dq0*(dq0*cos(q1)*sin(q0)*4.784E-1+dq1*cos(q0)*sin(q1)*4.784E-1)+dq1*(dq0*cos(q0)*sin(q1)*4.784E-1+dq1*cos(q1)*sin(q0)*4.784E-1);
