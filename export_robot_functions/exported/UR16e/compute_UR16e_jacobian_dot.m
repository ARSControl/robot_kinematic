function J_dot = compute_UR16e_jacobian_dot(q, dq)
...
J_dot(1,1) = 0.0016*dq0*cos(q0)*(225.0*cos(q1 + q2) + 299.0*cos(q1)) - 0.17415*dq0*sin(q0) - 0.11655*dq0*cos(q4)*sin(q0) - 0.11655*dq4*cos(q0)*sin(q4) - 0.11985*dq0*sin(q1 + q2 + q3)*cos(q0) - 0.11985*cos(q1 + q2 + q3)*sin(q0)*(dq1 + dq2 + dq3) - 0.0016*sin(q0)*(225.0*sin(q1 + q2)*(dq1 + dq2) + 299.0*dq1*sin(q1)) + 0.11655*dq0*cos(q1 + q2 + q3)*cos(q0)*sin(q4) + 0.11655*dq4*cos(q1 + q2 + q3)*cos(q4)*sin(q0) - 0.11655*sin(q1 + q2 + q3)*sin(q0)*sin(q4)*(dq1 + dq2 + dq3);

J_dot(1,2) = (cos(q0)*(7200.0*cos(q1 + q2)*(dq1 + dq2) - 2397.0*sin(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 9568.0*dq1*cos(q1) + 2331.0*dq4*sin(q1 + q2 + q3)*cos(q4) + 2331.0*cos(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3)))/20000 - (dq0*sin(q0)*(2397.0*cos(q1 + q2 + q3) + 7200.0*sin(q1 + q2) + 9568.0*sin(q1) + 2331.0*sin(q1 + q2 + q3)*sin(q4)))/20000;

J_dot(1,3) = (3*cos(q0)*(2400.0*cos(q1 + q2)*(dq1 + dq2) - 799.0*sin(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 777.0*dq4*sin(q1 + q2 + q3)*cos(q4) + 777.0*cos(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3)))/20000 - (3*dq0*sin(q0)*(799.0*cos(q1 + q2 + q3) + 2400.0*sin(q1 + q2) + 777.0*sin(q1 + q2 + q3)*sin(q4)))/20000;
...
J_dot(2,1) = 0.0016*cos(q0)*(225.0*sin(q1 + q2)*(dq1 + dq2) + 299.0*dq1*sin(q1)) + 0.17415*dq0*cos(q0) + 0.11655*dq0*cos(q0)*cos(q4) - 0.11655*dq4*sin(q0)*sin(q4) - 0.11985*dq0*sin(q1 + q2 + q3)*sin(q0) + 0.11985*cos(q1 + q2 + q3)*cos(q0)*(dq1 + dq2 + dq3) + 0.0016*dq0*sin(q0)*(225.0*cos(q1 + q2) + 299.0*cos(q1)) - 0.11655*dq4*cos(q1 + q2 + q3)*cos(q0)*cos(q4) + 0.11655*dq0*cos(q1 + q2 + q3)*sin(q0)*sin(q4) + 0.11655*sin(q1 + q2 + q3)*cos(q0)*sin(q4)*(dq1 + dq2 + dq3);

J_dot(2,2) = (sin(q0)*(7200.0*cos(q1 + q2)*(dq1 + dq2) - 2397.0*sin(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 9568.0*dq1*cos(q1) + 2331.0*dq4*sin(q1 + q2 + q3)*cos(q4) + 2331.0*cos(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3)))/20000 + (dq0*cos(q0)*(2397.0*cos(q1 + q2 + q3) + 7200.0*sin(q1 + q2) + 9568.0*sin(q1) + 2331.0*sin(q1 + q2 + q3)*sin(q4)))/20000;

J_dot(2,3) = (3*sin(q0)*(2400.0*cos(q1 + q2)*(dq1 + dq2) - 799.0*sin(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 777.0*dq4*sin(q1 + q2 + q3)*cos(q4) + 777.0*cos(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3)))/20000 + (3*dq0*cos(q0)*(799.0*cos(q1 + q2 + q3) + 2400.0*sin(q1 + q2) + 777.0*sin(q1 + q2 + q3)*sin(q4)))/20000;
...
J_dot(3,2) = 0.11985*cos(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 0.36*sin(q1 + q2)*(dq1 + dq2) + 0.4784*dq1*sin(q1) - 0.11655*dq4*cos(q1 + q2 + q3)*cos(q4) + 0.11655*sin(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3);

J_dot(3,3) = 0.11985*cos(q1 + q2 + q3)*(dq1 + dq2 + dq3) + 0.36*sin(q1 + q2)*(dq1 + dq2) - 0.11655*dq4*cos(q1 + q2 + q3)*cos(q4) + 0.11655*sin(q1 + q2 + q3)*sin(q4)*(dq1 + dq2 + dq3);
