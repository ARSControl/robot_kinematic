...
T(1,4) = 0.17415*sin(q0) + 0.11985*sin(q1 + q2 + q3)*cos(q0) - 0.0016*cos(q0)*(225.0*cos(q1 + q2) + 299.0*cos(q1));
...
T(2,4) = 0.11985*sin(q1 + q2 + q3)*sin(q0) - 0.17415*cos(q0) - 0.0016*sin(q0)*(225.0*cos(q1 + q2) + 299.0*cos(q1));
...
T(3,4) = 0.1807 - 0.36*sin(q1 + q2) - 0.4784*sin(q1) - 0.11985*cos(q1 + q2 + q3);
