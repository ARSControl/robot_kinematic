function J = compute_UR16e_jacobian_2(q)
...
J(1,1) = 0.4784*cos(q1)*sin(q0) - 0.36*sin(q0)*sin(q1)*sin(q2) + 0.36*cos(q1)*cos(q2)*sin(q0);
...
J(2,1) = 0.36*cos(q0)*sin(q1)*sin(q2) - 0.36*cos(q0)*cos(q1)*cos(q2) - 0.4784*cos(q0)*cos(q1);
