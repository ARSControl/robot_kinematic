...
// Eigen::Matrix<double, 4, 4> compute_UR16e_direct_kinematic_3(Eigen::Matrix<double, 6, 1> q){
extern "C" void compute_UR16e_direct_kinematic_3(double* result, double *q) {
...
T(0,3) = sin(q0)*1.7415E-1-cos(q0)*cos(q1)*4.784E-1-cos(q0)*cos(q1)*cos(q2)*3.6E-1+cos(q0)*sin(q1)*sin(q2)*3.6E-1;
...
T(1,3) = cos(q0)*-1.7415E-1-cos(q1)*sin(q0)*4.784E-1+sin(q0)*sin(q1)*sin(q2)*3.6E-1-cos(q1)*cos(q2)*sin(q0)*3.6E-1;
...
T(2,3) = sin(q1)*-4.784E-1-cos(q1)*sin(q2)*3.6E-1-cos(q2)*sin(q1)*3.6E-1+1.807E-1;
