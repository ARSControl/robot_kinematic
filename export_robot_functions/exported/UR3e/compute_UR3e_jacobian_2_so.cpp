...
extern "C" void compute_UR3e_jacobian_2(double* result, double *q) {
...
J(0,0) = (sin(q0)*(cos(q1+q2)*4.264E+3+cos(q1)*4.871E+3))/2.0E+4;

J(0,1) = (cos(q0)*(sin(q1+q2)*4.264E+3+sin(q1)*4.871E+3))/2.0E+4;

J(0,2) = sin(q1+q2)*cos(q0)*2.132E-1;

J(1,0) = cos(q0)*(cos(q1+q2)*4.264E+3+cos(q1)*4.871E+3)*(-5.0E-5);

J(1,1) = (sin(q0)*(sin(q1+q2)*4.264E+3+sin(q1)*4.871E+3))/2.0E+4;
