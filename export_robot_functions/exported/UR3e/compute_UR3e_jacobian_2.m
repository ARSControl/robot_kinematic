function J = compute_UR3e_jacobian_2(q)
...
J(1,1) = 0.24355*cos(q1)*sin(q0) - 0.2132*sin(q0)*sin(q1)*sin(q2) + 0.2132*cos(q1)*cos(q2)*sin(q0);
...
J(2,1) = 0.2132*cos(q0)*sin(q1)*sin(q2) - 0.2132*cos(q0)*cos(q1)*cos(q2) - 0.24355*cos(q0)*cos(q1);
