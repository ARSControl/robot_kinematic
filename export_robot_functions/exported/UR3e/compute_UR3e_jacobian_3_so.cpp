...
extern "C" void compute_UR3e_jacobian_3(double* result, double *q) {
...
J(0,0) = cos(q0)*1.3105E-1+cos(q1)*sin(q0)*2.4355E-1-sin(q0)*sin(q1)*sin(q2)*2.132E-1+cos(q1)*cos(q2)*sin(q0)*2.132E-1;
...
J(1,0) = sin(q0)*1.3105E-1-cos(q0)*cos(q1)*2.4355E-1-cos(q0)*cos(q1)*cos(q2)*2.132E-1+cos(q0)*sin(q1)*sin(q2)*2.132E-1;
