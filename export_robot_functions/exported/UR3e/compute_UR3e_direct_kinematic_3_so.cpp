...
extern "C" void compute_UR3e_direct_kinematic_3(double* result, double *q) {
...
T(0,3) = sin(q0)*1.3105E-1-cos(q0)*(cos(q1+q2)*4.264E+3+cos(q1)*4.871E+3)*5.0E-5;
...
T(1,3) = cos(q0)*-1.3105E-1-sin(q0)*(cos(q1+q2)*4.264E+3+cos(q1)*4.871E+3)*5.0E-5;
