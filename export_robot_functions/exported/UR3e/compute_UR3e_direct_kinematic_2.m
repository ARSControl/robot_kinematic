function T = compute_UR3e_direct_kinematic_2(q)
...
T(1,4) = 0.2132*cos(q0)*sin(q1)*sin(q2) - 0.2132*cos(q0)*cos(q1)*cos(q2) - 0.24355*cos(q0)*cos(q1);
...
T(2,4) = 0.2132*sin(q0)*sin(q1)*sin(q2) - 0.24355*cos(q1)*sin(q0) - 0.2132*cos(q1)*cos(q2)*sin(q0);
