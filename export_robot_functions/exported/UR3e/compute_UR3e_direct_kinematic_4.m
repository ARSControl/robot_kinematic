...
T(1,4) = 0.13105*sin(q0) + 0.08535*sin(q1 + q2 + q3)*cos(q0) - 0.00005*cos(q0)*(4264.0*cos(q1 + q2) + 4871.0*cos(q1));
...
T(2,4) = 0.08535*sin(q1 + q2 + q3)*sin(q0) - 0.13105*cos(q0) - 0.00005*sin(q0)*(4264.0*cos(q1 + q2) + 4871.0*cos(q1));
...
T(3,4) = 0.15185 - 0.2132*sin(q1 + q2) - 0.24355*sin(q1) - 0.08535*cos(q1 + q2 + q3);
