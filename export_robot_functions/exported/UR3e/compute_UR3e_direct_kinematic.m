...
T(1,4) = 0.13105*sin(q0) - 0.24355*cos(q0)*cos(q1) + 0.0921*cos(q4)*sin(q0) - 0.0921*sin(q4)*(cos(q3)*(cos(q0)*cos(q1)*cos(q2) - 1.0*cos(q0)*sin(q1)*sin(q2)) - 1.0*sin(q3)*(1.0*cos(q0)*cos(q1)*sin(q2) + 1.0*cos(q0)*cos(q2)*sin(q1))) + 0.08535*sin(q3)*(cos(q0)*cos(q1)*cos(q2) - 1.0*cos(q0)*sin(q1)*sin(q2)) + 0.08535*cos(q3)*(1.0*cos(q0)*cos(q1)*sin(q2) + 1.0*cos(q0)*cos(q2)*sin(q1)) - 0.2132*cos(q0)*cos(q1)*cos(q2) + 0.2132*cos(q0)*sin(q1)*sin(q2);
...
T(2,4) = 0.08535*cos(q3)*(1.0*cos(q1)*sin(q0)*sin(q2) + 1.0*cos(q2)*sin(q0)*sin(q1)) - 0.0921*cos(q0)*cos(q4) - 0.13105*cos(q0) - 0.24355*cos(q1)*sin(q0) - 0.08535*sin(q3)*(1.0*sin(q0)*sin(q1)*sin(q2) - 1.0*cos(q1)*cos(q2)*sin(q0)) + 0.0921*sin(q4)*(1.0*cos(q3)*(1.0*sin(q0)*sin(q1)*sin(q2) - 1.0*cos(q1)*cos(q2)*sin(q0)) + 1.0*sin(q3)*(1.0*cos(q1)*sin(q0)*sin(q2) + 1.0*cos(q2)*sin(q0)*sin(q1))) + 0.2132*sin(q0)*sin(q1)*sin(q2) - 0.2132*cos(q1)*cos(q2)*sin(q0);
...
T(3,4) = 0.08535*sin(q3)*(1.0*cos(q1)*sin(q2) + 1.0*cos(q2)*sin(q1)) - 0.2132*cos(q1)*sin(q2) - 0.2132*cos(q2)*sin(q1) - 0.0921*sin(q4)*(cos(q3)*(1.0*cos(q1)*sin(q2) + 1.0*cos(q2)*sin(q1)) + sin(q3)*(1.0*cos(q1)*cos(q2) - 1.0*sin(q1)*sin(q2))) - 0.08535*cos(q3)*(1.0*cos(q1)*cos(q2) - 1.0*sin(q1)*sin(q2)) - 0.24355*sin(q1) + 0.15185;
