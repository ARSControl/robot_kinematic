function J = compute_UR10e_jacobian_2(q)
...
J(1,1) = 0.6127*cos(q1)*sin(q0) - 0.57155*sin(q0)*sin(q1)*sin(q2) + 0.57155*cos(q1)*cos(q2)*sin(q0);
...
J(2,1) = 0.57155*cos(q0)*sin(q1)*sin(q2) - 0.57155*cos(q0)*cos(q1)*cos(q2) - 0.6127*cos(q0)*cos(q1);
