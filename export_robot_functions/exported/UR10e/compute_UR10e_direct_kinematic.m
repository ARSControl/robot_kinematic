...
T(1,4) = 0.17415*sin(q0) + 0.11655*cos(q4)*sin(q0) + 0.11985*sin(q1 + q2 + q3)*cos(q0) - 0.00005*cos(q0)*(11431.0*cos(q1 + q2) + 12254.0*cos(q1)) - 0.11655*cos(q1 + q2 + q3)*cos(q0)*sin(q4);
...
T(2,4) = 0.11985*sin(q1 + q2 + q3)*sin(q0) - 0.11655*cos(q0)*cos(q4) - 0.17415*cos(q0) - 0.00005*sin(q0)*(11431.0*cos(q1 + q2) + 12254.0*cos(q1)) - 0.11655*cos(q1 + q2 + q3)*sin(q0)*sin(q4);
...
T(3,4) = 0.1807 - 0.57155*sin(q1 + q2) - 0.6127*sin(q1) - 0.11655*sin(q1 + q2 + q3)*sin(q4) - 0.11985*cos(q1 + q2 + q3);
