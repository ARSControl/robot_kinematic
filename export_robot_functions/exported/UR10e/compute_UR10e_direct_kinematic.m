function T = compute_UR10e_direct_kinematic(q)
...
T(1,4) = 0.17415*sin(q0) - 0.6127*cos(q0)*cos(q1) + 0.11655*cos(q4)*sin(q0) - 0.11655*sin(q4)*(cos(q3)*(cos(q0)*cos(q1)*cos(q2) - 1.0*cos(q0)*sin(q1)*sin(q2)) - 1.0*sin(q3)*(1.0*cos(q0)*cos(q1)*sin(q2) + 1.0*cos(q0)*cos(q2)*sin(q1))) + 0.11985*sin(q3)*(cos(q0)*cos(q1)*cos(q2) - 1.0*cos(q0)*sin(q1)*sin(q2)) + 0.11985*cos(q3)*(1.0*cos(q0)*cos(q1)*sin(q2) + 1.0*cos(q0)*cos(q2)*sin(q1)) - 0.57155*cos(q0)*cos(q1)*cos(q2) + 0.57155*cos(q0)*sin(q1)*sin(q2);
...
T(2,4) = 0.11985*cos(q3)*(1.0*cos(q1)*sin(q0)*sin(q2) + 1.0*cos(q2)*sin(q0)*sin(q1)) - 0.11655*cos(q0)*cos(q4) - 0.17415*cos(q0) - 0.6127*cos(q1)*sin(q0) - 0.11985*sin(q3)*(1.0*sin(q0)*sin(q1)*sin(q2) - 1.0*cos(q1)*cos(q2)*sin(q0)) + 0.11655*sin(q4)*(1.0*cos(q3)*(1.0*sin(q0)*sin(q1)*sin(q2) - 1.0*cos(q1)*cos(q2)*sin(q0)) + 1.0*sin(q3)*(1.0*cos(q1)*sin(q0)*sin(q2) + 1.0*cos(q2)*sin(q0)*sin(q1))) + 0.57155*sin(q0)*sin(q1)*sin(q2) - 0.57155*cos(q1)*cos(q2)*sin(q0);
...
T(3,4) = 0.11985*sin(q3)*(1.0*cos(q1)*sin(q2) + 1.0*cos(q2)*sin(q1)) - 0.57155*cos(q1)*sin(q2) - 0.57155*cos(q2)*sin(q1) - 0.11655*sin(q4)*(cos(q3)*(1.0*cos(q1)*sin(q2) + 1.0*cos(q2)*sin(q1)) + sin(q3)*(1.0*cos(q1)*cos(q2) - 1.0*sin(q1)*sin(q2))) - 0.11985*cos(q3)*(1.0*cos(q1)*cos(q2) - 1.0*sin(q1)*sin(q2)) - 0.6127*sin(q1) + 0.1807;
