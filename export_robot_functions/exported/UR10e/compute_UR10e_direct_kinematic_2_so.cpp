...
T(0,3) = cos(q0)*cos(q1)*-6.127E-1-cos(q0)*cos(q1)*cos(q2)*5.7155E-1+cos(q0)*sin(q1)*sin(q2)*5.7155E-1;
...
T(1,3) = cos(q1)*sin(q0)*-6.127E-1+sin(q0)*sin(q1)*sin(q2)*5.7155E-1-cos(q1)*cos(q2)*sin(q0)*5.7155E-1;
