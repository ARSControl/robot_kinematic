function T = compute_UR10e_direct_kinematic_3(q)
...
T(1,4) = 0.17415*sin(q0) - 0.6127*cos(q0)*cos(q1) - 0.57155*cos(q0)*cos(q1)*cos(q2) + 0.57155*cos(q0)*sin(q1)*sin(q2);
...
T(2,4) = 0.57155*sin(q0)*sin(q1)*sin(q2) - 0.6127*cos(q1)*sin(q0) - 0.17415*cos(q0) - 0.57155*cos(q1)*cos(q2)*sin(q0);
...
T(3,4) = 0.1807 - 0.57155*cos(q1)*sin(q2) - 0.57155*cos(q2)*sin(q1) - 0.6127*sin(q1);
