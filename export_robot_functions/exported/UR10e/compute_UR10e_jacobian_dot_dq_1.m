...
J_dot_dq(1,1) = dq0*(0.6127*dq0*cos(q0)*cos(q1) - 0.6127*dq1*sin(q0)*sin(q1)) + dq1*(0.6127*dq1*cos(q0)*cos(q1) - 0.6127*dq0*sin(q0)*sin(q1));

J_dot_dq(2,1) = dq0*(0.6127*dq0*cos(q1)*sin(q0) + 0.6127*dq1*cos(q0)*sin(q1)) + dq1*(0.6127*dq0*cos(q0)*sin(q1) + 0.6127*dq1*cos(q1)*sin(q0));
