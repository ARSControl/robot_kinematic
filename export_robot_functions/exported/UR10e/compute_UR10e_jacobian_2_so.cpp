...
// Eigen::Matrix<double, 6, 6> compute_UR10e_jacobian_2(Eigen::Matrix<double, 6, 1> q){
extern "C" void compute_UR10e_jacobian_2(double* result, double *q) {
...
J(0,0) = cos(q1)*sin(q0)*6.127E-1-sin(q0)*sin(q1)*sin(q2)*5.7155E-1+cos(q1)*cos(q2)*sin(q0)*5.7155E-1;
...
J(1,0) = cos(q0)*cos(q1)*-6.127E-1-cos(q0)*cos(q1)*cos(q2)*5.7155E-1+cos(q0)*sin(q1)*sin(q2)*5.7155E-1;
