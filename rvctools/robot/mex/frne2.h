...
typedef struct _link {
    ...
    /**************** of links ********************************/
    double    *rbar;      /* centre of mass of link wrt link origin */
     ...
     **********************************************************/
    double    *r;          /* distance of ith origin from i-1th wrt ith */
    Rot R;              /* link rotation matrix */
    double *    omega;      /* angular velocity */
    double *    omega_d;    /* angular acceleration */
    double *    acc;        /* acceleration */
    double *    abar;       /* acceleration of centre of mass */
    double *    f;          /* inter-link force */
    double *    n;          /* inter-link moment */
} Link;

/* A robot */
typedef struct _robot {
    int njoints;    /* number of joints */
    double    *gravity;   /* gravity vector */
